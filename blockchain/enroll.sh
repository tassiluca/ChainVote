...
# preparation
mkdir -p $ARTIFACTS_DIR/org1/peer2/assets/ca 
cp $ARTIFACTS_DIR/org1/ca/admin/msp/cacerts/0-0-0-0-7054.pem $ARTIFACTS_DIR/org1/peer2/assets/ca/org1-ca-cert.pem

mkdir -p $ARTIFACTS_DIR/org1/peer2/assets/tls-ca 
cp $ARTIFACTS_DIR/tls-ca/admin/msp/cacerts/0-0-0-0-7052.pem $ARTIFACTS_DIR/org1/peer2/assets/tls-ca/tls-ca-cert.pem

# for identity
export FABRIC_CA_CLIENT_HOME=$ARTIFACTS_DIR/org1/peer2
export FABRIC_CA_CLIENT_TLS_CERTFILES=$ARTIFACTS_DIR/org1/peer2/assets/ca/org1-ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
...
# for TLS
export FABRIC_CA_CLIENT_MSPDIR=tls-msp
export FABRIC_CA_CLIENT_TLS_CERTFILES=$ARTIFACTS_DIR/org1/peer2/assets/tls-ca/tls-ca-cert.pem
...
cp $ARTIFACTS_DIR/org1/peer2/tls-msp/keystore/*_sk $ARTIFACTS_DIR/org1/peer2/tls-msp/keystore/key.pem
...
mkdir -p $ARTIFACTS_DIR/org1/peer2/msp/admincerts
cp $ARTIFACTS_DIR/org1/admin/msp/signcerts/cert.pem $ARTIFACTS_DIR/org1/peer2/msp/admincerts/org1-admin-cert.pem
