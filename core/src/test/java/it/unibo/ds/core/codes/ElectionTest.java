...
public class ElectionTest {
    ...
    static class TestBuild {
        ...
        void testCorrectBuildElectionClosedWithResults() {
            ...
            LocalDateTime endDate = LocalDateTime.of(endMap.get("y"), endMap.get("M"), endMap.get("d"),
                    endMap.get("h"), endMap.get("m"), endMap.get("s"));

            ElectionInfo electionInfo = ElectionFactory
                    .buildElectionInfo(GOAL, VOTERS, START_DATE, endDate, CHOICES);
            ...
            assertDoesNotThrow(() -> ElectionFactory
                    .buildElection(electionInfo, resultsToSet));
        }
